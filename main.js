...
function create() {
        ...
        //experiemental
            ...
            game.physics.p2.stiffness = 1e7;
            game.physics.p2.relaxation = 0;
            game.physics.p2.frictionStiffness = 1e7;
            game.physics.p2.frictionRelaxation = 3;
            game.physics.p2.surfaceVelocity = 0;
//        game.physics.startSystem(Phaser.Physics.P2JS);game.physics.p2.applyGravity = false;
//        
        // *Spawn Player
...
// var width = 16; 
    ...
    newPart.tint = uniTint;
                                                             pH = newPart;
                                                             pH.body.mass = 0.1;
                                                             pH.body.data.gravityScale = 0.01;
//    game.physics.p2.createRevoluteConstraint(newPart, [0, 20], lastPart, [0, -50], maxForce);
    game.physics.p2.createLockConstraint(pT, pH, [0,75], 0);
    // Left Arm Top
    ...
    newPart.body.setCollisionGroup(limbCollisionGroup);
                                                                pLAB = newPart;
       newPart.tint = uniTint;                                  pLAB.body.mass = 0.1;   
                                                                pLAB.body.data.gravityScale = 0.01;
    ...
    newPart.body.setCollisionGroup(limbCollisionGroup);
                                                                xHand = newPart;
                                                                xHand.body.mass = 0.8;
                                                                xHand.body.data.gravityScale = 0.01;
    ...
    newPart.body.setCollisionGroup(limbCollisionGroup);
                                                                pRAT = newPart;
                                                                pRAT.body.mass = 0.1;
                                                                pRAT.body.data.gravityScale = 0.01;
    ...
    newPart.body.setCollisionGroup(limbCollisionGroup);
                                                                pRAB = newPart;
                                                                pRAB.body.mass = 0.1;
                                                                pRAB.body.data.gravityScale = 0.01;
    ...
    newPart.body.setCollisionGroup(limbCollisionGroup);
                                                                aHand = newPart;
                                                                aHand.body.mass = 0.8;
                                                                aHand.body.data.gravityScale = 0.01;
    ...
    newPart.body.setCollisionGroup(limbCollisionGroup);
                                                                pLLT = newPart;
                                                                pLLT.body.mass = 0.1;
                                                                pLLT.body.data.gravityScale = 0.01;
    ...
    newPart.body.setCollisionGroup(limbCollisionGroup);
                                                                pLLB = newPart;
                                                                pLLB.body.mass = 0.1;
                                                                pLLB.body.data.gravityScale = 0.01;
    game.physics.p2.createRevoluteConstraint(newPart, [0, -25], pLLT, [0, 30], maxForce);
    ...
    newPart.body.setCollisionGroup(limbCollisionGroup);
                                                                yHand = newPart;
                                                                yHand.body.mass = 0.8;
                                                                yHand.body.data.gravityScale = 0.01;
    ...
    newPart.body.setCollisionGroup(limbCollisionGroup);
                                                                pRLT = newPart;
                                                                pRLT.body.mass = 0.1;
                                                                pRLT.body.data.gravityScale = 0.01;
    game.physics.p2.createRevoluteConstraint(newPart, [0, -25], lastPart, [+35, 40], maxForce);
    ...
    newPart.body.setCollisionGroup(limbCollisionGroup);
                                                                pRLB = newPart;
                                                                pRLB.body.mass = 0.1;
                                                                pRLB.body.data.gravityScale = 0.01;
    game.physics.p2.createRevoluteConstraint(newPart, [0, -25], pRLT, [0, 35], maxForce);
    ...
    newPart.body.setCollisionGroup(limbCollisionGroup);
                                                                bHand = newPart;
                                                                bHand.body.data.gravityScale = 0.01;
                                                                bHand.body.mass = 0.8;
...
//pLAB.body.kinematic = true;
//pRAT.body.kinematic = true;
//pRAB.body.kinematic = true;
//pLLT.body.kinematic = true;
//pLLB.body.kinematic = true;
//pRLT.body.kinematic = true;
//pRLB.body.kinematic = true;
//xHand.body.kinematic = true;
//yHand.body.kinematic = true;
//bHand.body.kinematic = true;
//aHand.body.kinematic = true;
//pH.body.kinematic = true;
       ...
       var gp = navigator.getGamepads()[0];
        ...
        if (gp.buttons[2].pressed) { //X xHand left of pLA left arm
            ...
            xHand.body.velocity.y = vforce * axeLy;
               ...
               if (gp.buttons[4].pressed){ //Left bumper augment
...
//        if (gp.buttons[9].pressed) { // Cannot unpause derp
//             
//             if (game.paused){
//                 game.paused = false;
//                 xStuck = false;
